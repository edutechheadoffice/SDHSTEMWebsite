...
function showToast(message, type = "success") {
  ...
  if (type === "warning") {
    ...
    toastIcon.innerHTML = `<i class="bi bi-exclamation-circle-fill"></i>`;
    toast.classList.add("toast-warning");
  }


  if (type === "loading") {
    toastTitle.innerText = "Uploading";
    toastIcon.innerHTML = `<span class="spinner-border spinner-border-sm"></span>`;
...
$('#createPostModal').on('shown.bs.modal', function () {
  ...
  if (!$('#postTags').hasClass("select2-hidden-accessible")) {
